    ...
    public class LogFile {
        ...
        public bool saveLogDetail() {
            try {
                ...
                string f = string.Format("{0}\\EW30CX_{1}_{2}_{3}.txt", dir_log_detail, myGlobal.myTesting.macStamp, DateTime.Now.ToString("hhmmss"), myGlobal.myTesting.totalResult);
        ...
        public bool saveLogTotal() {
            try {
                string f = string.Format("{0}\\EW30CX_{1}.csv", dir_log_total, DateTime.Now.ToString("yyyyMMdd"));
